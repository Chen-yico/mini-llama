...
inline void AddLayerTensors(std::vector<GgufTensorFixture>& tensors,
  ...
  tensors.push_back({prefix + "attn_q.weight", lw.wq.shape, lw.wq.f32_data.data(),
                     lw.wq.f32_data.size(), 0});
  tensors.push_back({prefix + "attn_k.weight", lw.wk.shape, lw.wk.f32_data.data(),
                     lw.wk.f32_data.size(), 0});
  tensors.push_back({prefix + "attn_v.weight", lw.wv.shape, lw.wv.f32_data.data(),
                     lw.wv.f32_data.size(), 0});
  ...
  tensors.push_back({prefix + "ffn_down.weight", lw.w_down.shape,
                     lw.w_down.f32_data.data(), lw.w_down.f32_data.size(),
                     0});
}
